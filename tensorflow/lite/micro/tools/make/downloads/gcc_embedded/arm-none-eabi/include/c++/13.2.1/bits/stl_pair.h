...
#include <gcc_embedded/arm-none-eabi/include/c++/13.2.1/type_traits>   // for std::__decay_and_strip
#include <gcc_embedded/arm-none-eabi/include/c++/13.2.1/bits/move.h>   // for std::move / std::forward, and std::swap
#include "utility.h" // for std::tuple_element, std::tuple_size
#endif
