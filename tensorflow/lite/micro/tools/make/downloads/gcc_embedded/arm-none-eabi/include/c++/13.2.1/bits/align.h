...
#include <gcc_embedded/arm-none-eabi/include/c++/13.2.1/bit>          // std::has_single_bit
#include <stdint.h>     // uintptr_t
#include <gcc_embedded/arm-none-eabi/include/c++/13.2.1/debug/assertions.h> // _GLIBCXX_DEBUG_ASSERT
