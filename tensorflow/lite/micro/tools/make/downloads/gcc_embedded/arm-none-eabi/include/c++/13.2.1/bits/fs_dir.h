...
#include <gcc_embedded/arm-none-eabi/include/c++/13.2.1/compare>	// std::strong_ordering
#include <gcc_embedded/arm-none-eabi/include/c++/13.2.1/bits/iterator_concepts.h>	// std::default_sentinel_t
#endif
